    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Messages et annonces de l&apos;école</p>
        </div>
        {unreadCount > 0 && (
          <Button
            variant="outline"
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 gap-4">
            ...
            <p className="text-muted-foreground text-center">Aucune notification pour le moment</p>
              ...
              <Card
                ...
                className={`transition-all cursor-pointer hover:shadow-md ${
                  notif.read
                    ...
                    : 'bg-white border-blue-200 shadow-sm dark:bg-blue-950/10 dark:border-blue-800'
                }`}
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      <div className="flex items-center gap-3 text-xs text-muted-foreground">
                        <span className="flex items-center gap-1">
                          ...
                          {formatDate(notif.createdAt)} à {formatTime(notif.createdAt)}
                        </span>
                      </div>
                    </div>
